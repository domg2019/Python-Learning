...
# ToDo: import schedule/pyttsx3 modules?
...
def create_chrome_drive(*, headless=False):
    ...
    web_drive = Chrome(r"/Users/LUISLIU1/OneDrive - Schenker AG/Google/Chrome/Applicat"
                       r"ion/chromedriver.exe", options=options)
...
def create_firefox_drive():
    ...
    executable_path = "/Users/LUISLIU1/Desktop/python/geckodriver-v0.31.0-win64/geckodriver.exe"
...
if __name__ == '__main__':
    ...
    stream_url, stream_choice = choose_check_stream()
    ...
    # url="https://b2bi4-sword.dc.signintra.com/ui/"
